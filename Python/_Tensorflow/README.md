# Acute Myeloid/Lymphoblastic Leukemia Python Tensorflow Classifiers
![Peter Moss Acute Myeloid/Lymphoblastic Leukemia Detection System](../../Media/Images/banner.png)
The Peter Moss Acute Myeloid/Lymphoblastic Leukemia Python Tensorflow classifiers are a collection of projects that use computer vision written in Python and using the Tensorflow framework to classify Acute Myeloid/Lymphoblastic Leukemia in unseen images.
